...
class FvCarousel$$module$lib$FvCarousel$FvCarousel{constructor(a,b=DEFAULT_PARAM$$module$lib$FvCarousel$FvCarousel){this._itemClass=".fv-carousel-item";this.___i=0;this.__=document.querySelector(a);this.___=this.__.querySelectorAll(this._itemClass);this.prevBtn=document.querySelector(b.prev);this.nextBtn=document.querySelector(b.next);this.dotsContainer=document.querySelector(b.dots.el);this.dotsDirection=b.dots.direction;this.slideDirection=b.direction;this.timeout=b.timeout??5E3;this.itemsCount=
b.items??2;this.autoplaySpeed=b.autoplaySpeed??"500ms";this.elementMargin=b.margin;this.allowKeyDirection=void 0===b.keyDirection?!0:b.keyDirection;this.autoplay=void 0===b.autoplay?!0:b.autoplay;this.autoplayHoverPause=void 0===b.autoplayHoverPause?!0:b.autoplayHoverPause;this.allowDrag=void 0===b.allowDrag?!0:b.allowDrag;this.elementWidth="vertical"===b.direction?this.__.offsetWidth:this.__.offsetWidth/this.itemsCount;this.elementHeight=this.___[0].getBoundingClientRect().height;this.start()}start(){var a=
document.createElement("style");a.innerHTML=CAROUSEL_STYLE$$module$lib$FvCarousel$FvCarousel;document.querySelector("head").append(a);this.__.classList.add("fv-carousel");a=document.createElement(DIV_NODE$$module$lib$FvCarousel$FvCarousel);a.classList.add("fv-carousel-inner");this.__.appendChild(a);let b=document.createElement(DIV_NODE$$module$lib$FvCarousel$FvCarousel);b.classList.add("fv-carousel-group",`direction-${this.slideDirection}`);a.appendChild(b);this.___.forEach((c,d)=>{b.appendChild(c)&&
...
this.nextBtn.addEventListener("click",()=>this.next()):null}autoPlay(){this.__autoplayId=setInterval(()=>{this.next()},this.timeout)}toIndex(a){this.rowMain.style.transition=`${this.autoplaySpeed} ease-in`;this.rowMain.style.transform=this.slideDirection.includes("horizontal")?`translate3d(-${a*this.elementWidth}px,0px,0px)`:`translate3d(0px,-${100*a}%,0px)`;this.rowMain.setAttribute(DATA_VISIBLE$$module$lib$FvCarousel$FvCarousel,a);this.dotsBgColor()}prev(){this.___i=0<this.___i?this.___i-1:this.___.length-
1;this.toIndex(this.___i);this.dotsBgColor()}next(){this.___i=this.___i<this.___.length-1?this.___i+1:0;this.toIndex(this.___i);this.dotsBgColor()}drag(){this.__.addEventListener("drag",a=>{a=a.pageX;0!==a?this.toIndex(a/1E3):!1});this.__.addEventListener("dragend",a=>{a.pageX<this.elementWidth/2?this.prev():this.next()})}keyDirection(){this.__.addEventListener("keyup",a=>{switch(a.code){case "ArrowRight":this.next();break;case "ArrowLeft":this.prev()}})}touchmove(){this.__.addEventListener("touchmove",
a=>{a=a.pageX;0!==a?this.toIndex(a/1E3):!1})}stopOnHover(){this.__.addEventListener("mouseenter",()=>{clearInterval(this.__autoplayId)});this.__.addEventListener("mouseleave",()=>{this.autoPlay()})}dots(){this.dotsContainer.classList.add("fv-carousel-dots");let a=document.createElement(DIV_NODE$$module$lib$FvCarousel$FvCarousel);a.classList.add("fv-carousel-dots-group",`direction-${this.dotsDirection}`);this.___.forEach((b,c)=>{b=document.createElement(DIV_NODE$$module$lib$FvCarousel$FvCarousel);
b.classList.add(DOT_CLASS$$module$lib$FvCarousel$FvCarousel);b.setAttribute(DATA_POSITION$$module$lib$FvCarousel$FvCarousel,c);0===c?b.classList.add("fv-dot-active"):b.classList.add("fv-dot-inactive");a.appendChild(b);b.addEventListener("click",()=>{this.toIndex(c);this.___i=c})});this.dotsContainer.appendChild(a)}dotsBgColor(){this.dotsContainer&&this.dotsContainer.querySelectorAll(`.${DOT_CLASS$$module$lib$FvCarousel$FvCarousel}`).forEach((a,b)=>{let c=parseInt(this.rowMain.getAttribute(DATA_VISIBLE$$module$lib$FvCarousel$FvCarousel));
a.setAttribute("class",`${DOT_CLASS$$module$lib$FvCarousel$FvCarousel} fv-dot-${c===b?"active":"inactive"}`)})}}window.FvCarousel=FvCarousel$$module$lib$FvCarousel$FvCarousel;var module$lib$FvCarousel$FvCarousel={};module$lib$FvCarousel$FvCarousel.default=FvCarousel$$module$lib$FvCarousel$FvCarousel;var module$fjs_init={};
